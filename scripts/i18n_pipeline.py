#!/usr/bin/env python3
"""One-shot i18n refresh: extract â†’ html scan â†’ js scan â†’ augment â†’ inject.
...
after the augment pass â€” that means a new TR string was hardcoded with
no curated translation and the EN_FALLBACK path was taken; the
maintainer should add an explicit translation to
scripts/i18n_translate.py (and i18n_augment.py for TRâ†’EN) before
merging.
"""
