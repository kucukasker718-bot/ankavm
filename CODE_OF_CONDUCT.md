...
1. **Be kind.** Treat contributors, maintainers, and users the way you'd want to be treated. Disagreement is fine; condescension, harassment, slurs, and personal attacks are not.
...
If someone is breaking these rules, email `root@ankavm.local`. Reports go to the project lead and are kept confidential.

We may, at our discretion:

- ask the offender to edit or delete a comment
- warn the offender in private
- temporarily mute or ban the offender from ANKAVM spaces
- permanently ban the offender

For severe cases (threats, doxxing, harassment campaigns) we will skip the warning and ban immediately.
